...
if(RMLUI_LUA_BINDINGS AND RMLUI_LUA_BINDINGS_LIBRARY STREQUAL "luau")
	if(NOT TARGET Luau.VM)
		find_package("Luau" REQUIRED)
	endif()
	add_library(RmlUi::External::Lua ALIAS Luau.VM)
	report_dependency_found_or_error("Lua" "Luau" Luau.VM "Lua bindings enabled with Luau")
endif()
